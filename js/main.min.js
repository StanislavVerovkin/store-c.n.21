!function (o) {
    ...
    o(window).on("scroll", function () {
        ...
        o("html, body").animate({scrollTop: 0}, 300)
    }), o(".js-show-header-dropdown").on("click", function () {
        o(this).parent().find(".header-dropdown")
    });
    for (var n = o(".js-show-header-dropdown"), i = -1, t = 0; t < n.length; t++) o(n[t]).on("click", function () {
        if (jQuery.inArray(this, n) == i) o(this).parent().find(".header-dropdown").toggleClass("show-header-dropdown"), i = -1; else {
            for (var e = 0; e < n.length; e++) o(n[e]).parent().find(".header-dropdown").removeClass("show-header-dropdown");
    ...
    o(window).on("scroll", function () {
        if (o(this).scrollTop() >= s) o(".header1").addClass("fixed-header"), o(d).css("top", -s); else {
    ...
    for (var a = o(".arrow-main-menu"), t = 0; t < a.length; t++) o(a[t]).on("click", function () {
