                    ...
                    <div class="flex-w">
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu sort" aria-labelledby="dropdownMenuButton">
                                <a class="dropdown-item" href="/shop?sort=price-asc">Price: low to high</a>
                                <a class="dropdown-item" href="/shop?sort=price-desc">Price: high to low</a>
                                <a class="dropdown-item" href="/shop?sort=popular">Popularity</a>
                            </div>
                        </div>
                    </div>
                </div>
